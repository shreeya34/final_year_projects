...
from .views import ChangePassword, ForgetPassword, login_view, register_user, user_profile,csv_upload_view,display_asin,csv_view,activity_view,delete_entry
